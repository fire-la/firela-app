...
/// Created transaction response (POST /transactions/batch succeeded item)
class CreatedTransaction {
  ...
  final String? payee;
  final String narration;
  final List<PostingResponse> postings;
  ...
  factory CreatedTransaction.fromJson(Map<String, dynamic> json) {
    return CreatedTransaction(
      ...
      narration: json['narration'] as String,
      postings: (json['postings'] as List<dynamic>)
          .map((e) => PostingResponse.fromJson(e as Map<String, dynamic>))
          .toList(),
      interpolated: json['interpolated'] as bool,
      booked: json['booked'] as bool,
      warnings: (json['warnings'] as List<dynamic>?)?.cast<String>(),
      createdAccountIds: (json['createdAccountIds'] as List<dynamic>)
          .cast<String>(),
    );
  }
}

/// Failed batch transaction error
class BatchTransactionError {
  final int index;
  final String error;

  const BatchTransactionError({
    required this.index,
    required this.error,
  });

  factory BatchTransactionError.fromJson(Map<String, dynamic> json) {
    return BatchTransactionError(
...
/// Batch transaction creation response (POST /transactions/batch)
class BatchTransactionResponse {
  final List<CreatedTransaction> succeeded;
  final List<BatchTransactionError> failed;
  ...
  factory BatchTransactionResponse.fromJson(Map<String, dynamic> json) {
    return BatchTransactionResponse(
      succeeded: (json['succeeded'] as List<dynamic>)
          .map((e) => CreatedTransaction.fromJson(e as Map<String, dynamic>))
          .toList(),
      failed: (json['failed'] as List<dynamic>)
          .map((e) => BatchTransactionError.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
}
