...
/// * [reviewData] - Review-type-specific data (JSONB). Structure varies by type: DUPLICATE: {newTransaction, existingTransaction, matchScore}, RULE_MATCH: {transaction, matchedRule, suggestedAccount}, PAYEE_MATCH: {originalPayee, suggestedPayee (optional displayName — localized dir PayeeProfile display name per request locale, #1389)}, ACCOUNT_VALIDATION: {invalidAccount, suggestedCorrection, similarAccounts}, PIPELINE_ERROR: {errorType, errorMessage}
...
abstract class ReviewDetailDto implements Built<ReviewDetailDto, ReviewDetailDtoBuilder> {
  ...
  /// Review-type-specific data (JSONB). Structure varies by type: DUPLICATE: {newTransaction, existingTransaction, matchScore}, RULE_MATCH: {transaction, matchedRule, suggestedAccount}, PAYEE_MATCH: {originalPayee, suggestedPayee (optional displayName — localized dir PayeeProfile display name per request locale, #1389)}, ACCOUNT_VALIDATION: {invalidAccount, suggestedCorrection, similarAccounts}, PIPELINE_ERROR: {errorType, errorMessage}
...
class _$ReviewDetailDtoSerializer implements PrimitiveSerializer<ReviewDetailDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield object.confidenceLevel == null ? null : serializers.serialize(
      ...
      specifiedType: const FullType.nullable(ReviewDetailDtoConfidenceLevelEnum),
    );
    yield r'summaryKey';
    yield serializers.serialize(
      object.summaryKey,
