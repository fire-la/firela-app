...
class LogosApi {
  ...
  const LogosApi(this._dio, this._serializers);

  /// Get asset logo by data source and symbol
  ///
  ///
  /// Parameters:
  /// * [dataSource] - Data source identifier (e.g., YAHOO, COINGECKO)
  ...
  Future<Response<void>> logoControllerGetLogoByDataSourceAndSymbol({
    ...
    final _path = r'/api/v1/market/logos/{dataSource}/{symbol}'
        .replaceAll(
            '{' r'dataSource' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> logoControllerGetLogoByUrl({
    required String url,
    required String region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/market/logos'.replaceAll(
        '{' r'region' '}',
        encodeQueryParameter(_serializers, region, const FullType(String))
            .toString());
    final _options = Options(
