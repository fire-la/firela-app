...
class LifeEventsApi {
  ...
  const LifeEventsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EventResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventResponseDto>> eventControllerCreate({ 
    required String region,
    required CreateBeanEventDto createBeanEventDto,
    ...
    final _path = r'/api/v1/{region}/bean/events'.replaceAll('{' r'region' '}', encodeQueryParameter(_serializers, region, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CreateBeanEventDto);
      _bodyData = _serializers.serialize(createBeanEventDto, specifiedType: _type);
    ...
    EventResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventResponseDto),
      ) as EventResponseDto;
  ...
  Future<Response<void>> eventControllerDelete({ 
    ...
    final _path = r'/api/v1/{region}/bean/events/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'region' '}', encodeQueryParameter(_serializers, region, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [region] - Region code for tenant context (decorative for life events)
  /// * [type] - Filter by life event type (exact match)
  /// * [q] - Search term for description (case-insensitive partial match)
  /// * [from] - Filter life events from this date (ISO 8601 format)
  /// * [to] - Filter life events to this date (ISO 8601 format)
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EventListResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventListResponseDto>> eventControllerFindAll({ 
    required String region,
    String? type,
    String? q,
    String? from,
    ...
    EventListResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EventListResponseDto),
      ) as EventListResponseDto;
    ...
    return Response<EventListResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [EventResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventResponseDto>> eventControllerFindOne({ 
    required String id,
    required String region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [EventResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EventResponseDto>> eventControllerUpdate({ 
    required String id,
    required String region,
    required UpdateBeanEventDto updateBeanEventDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateBeanEventDto);
      _bodyData = _serializers.serialize(updateBeanEventDto, specifiedType: _type);
