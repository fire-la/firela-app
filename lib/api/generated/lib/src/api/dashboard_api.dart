...
class DashboardApi {
  ...
  Future<Response<DashboardControllerGetAccounts200Response>> dashboardControllerGetAccounts({ 
    ...
    DashboardControllerGetAccounts200Response? _responseData;
  ...
  Future<Response<CashFlowResponseDto>> dashboardControllerGetCashFlow({ 
    ...
    CashFlowResponseDto? _responseData;
    ...
    return Response<CashFlowResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ExpensesByCategoryResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExpensesByCategoryResponseDto>> dashboardControllerGetExpenses({ 
    required String region,
    String? groupBy,
    String? period,
    String? flow,
    ...
    final _path = r'/api/v1/{region}/dashboard/expenses'.replaceAll('{' r'region' '}', encodeQueryParameter(_serializers, region, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ExpensesByCategoryResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ExpensesByCategoryResponseDto),
      ) as ExpensesByCategoryResponseDto;
    ...
    return Response<ExpensesByCategoryResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<NetWorthResponseDto>> dashboardControllerGetNetWorth({ 
    ...
    NetWorthResponseDto? _responseData;
    ...
    return Response<NetWorthResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
