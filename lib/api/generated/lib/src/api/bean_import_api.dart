...
class BeanImportApi {
  ...
  const BeanImportApi(this._dio, this._serializers);
  ...
  Future<Response<IdentifyResultDto>> fileImportControllerIdentifyFile({
    ...
    IdentifyResultDto? _responseData;
    ...
    return Response<IdentifyResultDto>(
      data: _responseData,
  ...
  Future<Response<ImportResultDto>> fileImportControllerImportFile({
    ...
    return Response<ImportResultDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
