...
class MarketDataApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SymbolQuoteDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SymbolQuoteDto>> symbolControllerGetQuote({ 
    ...
    final _path = r'/api/v1/market/symbols/{symbol}/quote'.replaceAll('{' r'symbol' '}', encodeQueryParameter(_serializers, symbol, const FullType(String)).toString());
    ...
    SymbolQuoteDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SymbolQuoteDto),
      ) as SymbolQuoteDto;
    ...
    return Response<SymbolQuoteDto>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SymbolSearchResultDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SymbolSearchResultDto>>> symbolControllerSearch({ 
    required String q,
    num? limit = 10,
    String? exchange,
    String? assetType,
    ...
    final _path = r'/api/v1/market/symbols/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<SymbolSearchResultDto>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(SymbolSearchResultDto)]),
      ) as BuiltList<SymbolSearchResultDto>;
    ...
    return Response<BuiltList<SymbolSearchResultDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
