...
class MarketDataApi {
  ...
  const MarketDataApi(this._dio, this._serializers);
  ...
  Future<Response<void>> marketDataController({
    ...
    final _path = r'/api/v1/market-data/{dataSource}/{symbol}'.replaceAll(
        '{' r'region' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> marketDataControllerGetMarketDataBySymbol({
    ...
    final _path = r'/api/v1/market-data/{dataSource}/{symbol}'
        .replaceAll(
            '{' r'dataSource' '}',
