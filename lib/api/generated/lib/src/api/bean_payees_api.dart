...
class BeanPayeesApi {
  ...
  Future<Response<PayeeAutocompleteResponseDto>> payeeControllerAutocomplete({
    ...
    PayeeAutocompleteResponseDto? _responseData;
    ...
    return Response<PayeeAutocompleteResponseDto>(
      data: _responseData,
  ...
  /// * [tag] - Filter by custom tag (returns payees that have this tag)
  /// * [isActive] - Filter by active status. Defaults to true (show only active payees).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<PayeeListResponseDto>> payeeControllerFindAll({
    ...
    PayeeListResponseDto? _responseData;
    ...
    return Response<PayeeListResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<PayeeStatsResponseDto>>>
    ...
    BuiltList<PayeeStatsResponseDto>? _responseData;
    ...
    return Response<BuiltList<PayeeStatsResponseDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
