...
class AccountApi {
  ...
  Future<Response<AccountResponse>> closeAccount({
    ...
    final _path = r'/{region}/bean/accounts/{id}/close'
        .replaceAll(
            '{' r'region' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [AccountResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountResponse>> createAccount({
    required String region,
    ...
    final _path = r'/{region}/bean/accounts'.replaceAll(
        '{' r'region' '}',
        encodeQueryParameter(_serializers, region, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<void>> deleteAccount({
    ...
    final _path = r'/{region}/bean/accounts/{id}'
        .replaceAll(
            '{' r'region' '}',
            encodeQueryParameter(_serializers, region, const FullType(String))
                .toString())
  ...
  /// * [isCustom] - Filter custom accounts only
  /// * [search] - Search in path and i18nKey
  /// * [limit]
  /// * [offset]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AccountListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountListResponse>> listAccounts({
    required String region,
    AccountType? type,
    ...
    final _queryParameters = <String, dynamic>{
      if (type != null)
        r'type': encodeQueryParameter(
            _serializers, type, const FullType(AccountType)),
      if (status != null)
        r'status': encodeQueryParameter(
            _serializers, status, const FullType(AccountStatus)),
      if (isCustom != null)
        r'isCustom':
    ...
    AccountListResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AccountListResponse),
    ...
    return Response<AccountListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [AccountResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountResponse>> reopenAccount({
    required String region,
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/{region}/bean/accounts/{id}/reopen'
        .replaceAll(
            '{' r'region' '}',
            encodeQueryParameter(_serializers, region, const FullType(String))
                .toString())
  ...
  Future<Response<AccountResponse>> updateAccount({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(updateAccountRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
