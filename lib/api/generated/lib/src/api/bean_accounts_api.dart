...
import 'package:firela_api/src/model/account_list_response_dto.dart';
...
class BeanAccountsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OpeningBalanceResultDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OpeningBalanceResultDto>> accountControllerAddOpeningBalance({ 
    required String id,
    required String region,
    required CreateOpeningBalanceDto createOpeningBalanceDto,
    ...
    final _path = r'/api/v1/{region}/bean/accounts/{id}/opening-balance'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'region' '}', encodeQueryParameter(_serializers, region, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CreateOpeningBalanceDto);
      _bodyData = _serializers.serialize(createOpeningBalanceDto, specifiedType: _type);
    ...
    OpeningBalanceResultDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(OpeningBalanceResultDto),
      ) as OpeningBalanceResultDto;
    ...
    return Response<OpeningBalanceResultDto>(
      data: _responseData,
  ...
  Future<Response<AccountListResponseDto>> accountControllerFindAll({ 
    ...
    AccountListResponseDto? _responseData;
    ...
    return Response<AccountListResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
