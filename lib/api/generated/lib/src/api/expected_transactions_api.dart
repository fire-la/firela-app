...
class ExpectedTransactionsApi {
  ...
  Future<Response<void>> expectedTransactionController({
    ...
    final _path = r'/api/v1/{region}/bean/expected-transactions/{id}/skip'
        .replaceAll(
            '{' r'region' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExpectedTransactionListResponseDto>>
    ...
    final _path = r'/api/v1/{region}/bean/expected-transactions'.replaceAll(
        '{' r'region' '}',
        encodeQueryParameter(_serializers, region, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExpectedTransactionResponseDto>>
    ...
    final _path = r'/api/v1/{region}/bean/expected-transactions/{id}'
        .replaceAll(
            '{' r'id' '}',
  ...
  Future<Response<ExpectedTransactionListResponseDto>>
    ...
    final _path = r'/api/v1/{region}/bean/expected-transactions/overdue'
        .replaceAll(
            '{' r'region' '}',
            encodeQueryParameter(_serializers, region, const FullType(String))
                .toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> expectedTransactionController_1({
    required String region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> expectedTransactionController_2({
    required String region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/{region}/bean/expected-transactions/{id}/match'
        .replaceAll(
            '{' r'region' '}',
            encodeQueryParameter(_serializers, region, const FullType(String))
                .toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> expectedTransactionController_3({
    required String region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// expectedTransactionController_4
  ///
  ///
  /// Parameters:
  /// * [region] - Region code (cn, us, de)
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> expectedTransactionController_4({
    required String region,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/{region}/bean/expected-transactions/{id}/enter'
        .replaceAll(
            '{' r'region' '}',
            encodeQueryParameter(_serializers, region, const FullType(String))
                .toString());
