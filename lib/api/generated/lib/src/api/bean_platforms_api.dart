...
class BeanPlatformsApi {
  ...
  const BeanPlatformsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> platformControllerCreate({ 
    required CreatePlatformDto createPlatformDto,
    ...
    final _path = r'/api/v1/bean/platforms';
    ...
    try {
      const _type = FullType(CreatePlatformDto);
      _bodyData = _serializers.serialize(createPlatformDto, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> platformControllerDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/bean/platforms/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> platformControllerFindAll({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<PlatformListItemDto>>> platformControllerGetPlatformList({ 
    ...
    final _path = r'/api/v1/bean/platforms/list';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlatformMatchResponseDto>> platformControllerMatchPlatforms({ 
    ...
    final _path = r'/api/v1/bean/platforms/match';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> platformControllerUpdate({ 
    required String id,
    required UpdatePlatformDto updatePlatformDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdatePlatformDto);
      _bodyData = _serializers.serialize(updatePlatformDto, specifiedType: _type);
