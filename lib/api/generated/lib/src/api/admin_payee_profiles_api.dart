...
class AdminPayeeProfilesApi {
  ...
  /// * [isActive] - Filter by active status (default: true - show only active)
  /// * [verified] - Filter by verification status. true = verified only, false = unverified only
  ...
  Future<Response<PayeeProfileListResponseDto>>
    ...
    PayeeProfileListResponseDto? _responseData;
    ...
    return Response<PayeeProfileListResponseDto>(
      data: _responseData,
