...
class BeanBalancesApi {
  ...
  const BeanBalancesApi(this._dio, this._serializers);
  ...
  Future<Response<BalanceResponseDto>> balanceControllerGetBalance({ 
    ...
    BalanceResponseDto? _responseData;
    ...
    return Response<BalanceResponseDto>(
      data: _responseData,
  ...
  Future<Response<MultiCurrencyBalanceResponseDto>> balanceControllerGetMultiCurrencyBalance({ 
    ...
    MultiCurrencyBalanceResponseDto? _responseData;
    ...
    return Response<MultiCurrencyBalanceResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
