...
------------- | ------------- | -------------
[**accountControllerAddOpeningBalance**](BeanAccountsApi.md#accountcontrolleraddopeningbalance) | **POST** /api/v1/{region}/bean/accounts/{id}/opening-balance | Post an opening-balance transaction
...
# **accountControllerAddOpeningBalance**
> OpeningBalanceResultDto accountControllerAddOpeningBalance(id, region, createOpeningBalanceDto)
...
final CreateOpeningBalanceDto createOpeningBalanceDto = ; // CreateOpeningBalanceDto | 

try {
    final response = api.accountControllerAddOpeningBalance(id, region, createOpeningBalanceDto);
    print(response);
} catch on DioException (e) {
    print('Exception when calling BeanAccountsApi->accountControllerAddOpeningBalance: $e\n');
}
```
 ...
 **createOpeningBalanceDto** | [**CreateOpeningBalanceDto**](CreateOpeningBalanceDto.md)|  | 

### Return type

[**OpeningBalanceResultDto**](OpeningBalanceResultDto.md)
...
final String search = search_example; // String | Search term for account path
 ...
 **search** | **String**| Search term for account path | [optional] 
