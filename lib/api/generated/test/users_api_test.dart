...
void main() {
  ...
  group(UsersApi, () {
    ...
    //
    //Future userControllerDeleteOwnUser(DeleteOwnUserDto deleteOwnUserDto) async
    ...
    //
    //Future userControllerDeleteUser(String id) async
    ...
    //
    //Future userControllerGetAllUserSettingsByPage(num pageNo, num pageSize) async
    ...
    //
    //Future userControllerGetAssetLiabilitySummary() async
    ...
    //
    //Future userControllerGetUser(String acceptLanguage) async
    ...
    //
    //Future userControllerGetUserInfo(String id) async
    ...
    //
    //Future<SignupResponseDto> userControllerSignupUser(SignupDto signupDto) async
    ...
    //
    //Future userControllerUpdateUserSetting(UpdateUserSettingDto updateUserSettingDto) async
