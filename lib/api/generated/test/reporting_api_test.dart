...
void main() {
  ...
  group(ReportingApi, () {
    ...
    //
    //Future<CashFlowTrendsResponseDto> reportingControllerGetCashFlowTrends(String region, { String period, String granularity }) async
    test('test reportingControllerGetCashFlowTrends', () async {
      // TODO
    });
