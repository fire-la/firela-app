...
<objective>
Add data synchronization with server, backup/restore functionality, and account management actions.

Purpose: Enable users to sync their data across devices and backup/restore their financial data.
Output: Sync functionality, data backup/restore, and account deletion features.
</objective>
...
- Signal pattern for state management
- Singleton service pattern (AuthManager, IgnApiService)
- Pull-to-refresh with HapticFeedback
- ProgressDialog or loading dialog for async operations
</context>
...
<task type="auto">
  ...
  <files>lib/features/settings/presentation/widgets/sync_status_widget.dart, lib/core/services/sync_service.dart, lib/core/constants/api_constants.dart, lib/core/constants/storage_keys.dart, lib/l10n/app_en.arb, lib/l10n/app_zh_CN.arb, lib/l10n/app_zh_TW.arb</files>
...
<task type="auto">
  ...
  <files>lib/core/services/backup_service.dart, lib/features/settings/presentation/pages/settings_page.dart, lib/features/settings/presentation/dialogs/backup_dialog.dart, lib/core/constants/storage_keys.dart, lib/l10n/app_en.arb, lib/l10n/app_zh_CN.arb, lib/l10n/app_zh_TW.arb</files>
...
Add i18n keys: backup, restore, backupData, restoreData, backupCreated, backupFailed, restoreSuccess, restoreFailed, backupWarning, lastBackup, noBackupFound.</action>
  <verify>flutter analyze passes, backup creates file and restore imports data</verify>
  <done>Backup and restore functionality working with file operations</done>
</task>

<task type="auto">
  <name>Task 3: Add account deletion</name>
  <files>lib/core/services/ign_api_service.dart, lib/core/constants/api_constants.dart, lib/features/settings/presentation/pages/account_settings_page.dart, lib/features/settings/presentation/dialogs/delete_account_dialog.dart, lib/l10n/app_en.arb, lib/l10n/app_zh_CN.arb, lib/l10n/app_zh_TW.arb</files>
...
4. Add account deletion button in AccountSettingsPage (red/danger styling).
